...
class Alipay::ClientTest < Minitest::Test
  ...
  def test_client_initialize
    refute_nil Alipay::Client.client
  end
  ...
  def test_sdk_execute_for_alipay_trade_app_pay
    ...
    assert_equal string, Alipay::Client.client.sdk_execute(
  ...
  def test_page_execute_url_for_alipay_trade_page_pay
    ...
    assert_equal url, Alipay::Client.client.page_execute_url(
      method: 'alipay.trade.page.pay',
      biz_content: {
        out_trade_no: '20160401000000',
  ...
  def test_page_execute_form_for_alipay_trade_page_pay
    ...
    assert_equal form, Alipay::Client.client.page_execute_form(
      method: 'alipay.trade.page.pay',
      biz_content: {
        out_trade_no: '20160401000000',
        product_code: 'FAST_INSTANT_TRADE_PAY',
  ...
  def test_execute_for_data_dataservice_bill_downloadurl_query
    ...
    assert_equal body, Alipay::Client.client.execute(
  ...
  def test_verify
    ...
    params[:sign] = Alipay::Client.client.sign(params)
    params[:sign_type] = 'RSA2'
    assert Alipay::Client.client.verify?(params)
  end
